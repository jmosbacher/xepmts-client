...
class Gain(object):
    ...
    def __init__(self, run_id=None, timestamp=None, detector=None, experiment=None, pmt_index=None, gain=None, gain_err=None, occup=None, occup_err=None, id=None, local_vars_configuration=None):  # noqa: E501
