...
class VoltageChangeApi(object):
    ...
    def delete_voltage_change_item_with_http_info(self, voltagechange_id, if_match, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('if_match' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `if_match` when calling `delete_voltage_change_item`")  # noqa: E501
    ...
    def put_voltage_change_item(self, voltagechange_id, if_match, voltage_change, **kwargs):  # noqa: E501
        """Replaces a VoltageChange document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_voltage_change_item(voltagechange_id, if_match, voltage_change, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_voltage_change_item_with_http_info(voltagechange_id, if_match, voltage_change, **kwargs)  # noqa: E501

    def put_voltage_change_item_with_http_info(self, voltagechange_id, if_match, voltage_change, **kwargs):  # noqa: E501
        """Replaces a VoltageChange document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_voltage_change_item_with_http_info(voltagechange_id, if_match, voltage_change, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('if_match' not in local_var_params or  # noqa: E501
                                                        local_var_params['if_match'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `if_match` when calling `put_voltage_change_item`")  # noqa: E501
        # verify the required parameter 'voltage_change' is set
        if self.api_client.client_side_validation and ('voltage_change' not in local_var_params or  # noqa: E501
                                                        local_var_params['voltage_change'] is None):  # noqa: E501
